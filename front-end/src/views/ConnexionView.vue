...
const handleLogin = async () => {
  ...
  try {
    ...
    // 1. Correction de l'URL pour correspondre à /api/auth/login du server.js
    ...
    const response = await fetch('http://localhost:3000/api/auth/login', {
      ...
      body: JSON.stringify({
        ...
        password: password.value // 2. Correction du nom de clé attendu par l'API (password)
    ...
    // On met à jour les données globales du token dans Pinia et LocalStorage
    ...
    // 3. Redirection unique vers le tableau de bord de gestion des risques
    ...
    alert('Impossible de contacter le serveur. Vérifiez qu\'il est bien lancé sur le port 3000.')
...
.auth-card h2 {
  ...
  color: #4477ce; /* Changement du orange StudyCare vers un bleu sécurité */
...
.btn-primary {
  ...
  background-color: #4477ce; /* Bleu au lieu du orange */
